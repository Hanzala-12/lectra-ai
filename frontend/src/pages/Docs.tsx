export function Docs() {
  return (
    <div className="max-w-7xl mx-auto px-6 py-24">
      <h1 className="text-5xl font-bold tracking-tight mb-8">API Documentation</h1>
      ...
      <div className="bg-surface border border-border rounded-xl p-8 mb-8 shadow-sm">
        <h3 className="text-xl font-bold mb-4 font-mono text-primary">POST /api/process-lecture</h3>
        <p className="text-muted mb-6">Upload a lecture recording to generate transcripts, explanations, and quizzes.</p>
        
        <div className="bg-bg rounded-lg p-4 font-mono text-sm text-muted overflow-x-auto border border-border shadow-inner">
          <pre>
