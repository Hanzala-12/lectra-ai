  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 flex flex-col h-[calc(100vh-80px)]">
      <div className="flex items-center justify-between mb-6 shrink-0">
        <div>
          <h1 className="text-3xl font-bold tracking-tight mb-1">Ask Your Lecture</h1>
          <p className="text-sm text-muted">Powered by RAG</p>
        </div>
        
        <div className="relative">
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-surface border border-border text-sm font-medium hover:bg-surface2 transition-colors shadow-sm">
      ...
      <div className="flex-1 bg-surface border border-border rounded-2xl overflow-hidden flex flex-col shadow-sm">
        <div className="flex-1 p-6 overflow-y-auto space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <div className="bg-surface2 rounded-2xl rounded-tl-none p-4 max-w-[80%] shadow-sm">
          ...
          <div className="flex gap-4 flex-row-reverse">
            ...
            <div className="bg-primary text-white rounded-2xl rounded-tr-none p-4 max-w-[80%] shadow-sm">
          ...
          <div className="flex gap-4">
            ...
            <div className="bg-surface2 rounded-2xl rounded-tl-none p-4 max-w-[80%] shadow-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="flex items-center gap-1 px-2 py-1 rounded bg-surface border border-border text-xs font-medium hover:border-primary/50 transition-colors shadow-sm">
                  <Clock className="w-3 h-3 text-primary" /> 14:32
                </button>
                <button className="flex items-center gap-1 px-2 py-1 rounded bg-surface border border-border text-xs font-medium hover:border-primary/50 transition-colors shadow-sm">
                  <Clock className="w-3 h-3 text-primary" /> 16:05
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 bg-surface border-t border-border">
          <div className="relative">
            <input 
              ...
              className="w-full pl-4 pr-12 py-3 rounded-xl border border-border bg-bg focus:border-primary outline-none shadow-sm transition-colors"
            />
            <button className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 rounded-lg bg-primary text-white flex items-center justify-center hover:bg-primary-dark transition-colors shadow-sm">
          ...
          <div className="flex items-center justify-between mt-2 px-2">
            ...
            <div className="flex gap-2">
              <button className="text-[10px] font-mono text-primary uppercase tracking-widest hover:underline">English</button>
