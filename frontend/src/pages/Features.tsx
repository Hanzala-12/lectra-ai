export function Features() {
  return (
    <div className="max-w-7xl mx-auto px-6 py-24">
      <h1 className="text-5xl font-bold tracking-tight mb-8">Features</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 mt-16">
        <div className="bg-surface border border-border rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
          <h3 className="text-2xl font-bold mb-4 tracking-tight">Smart Transcription</h3>
        ...
        <div className="bg-surface border border-border rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
          <h3 className="text-2xl font-bold mb-4 tracking-tight">Multilingual AI Explanations</h3>
        ...
        <div className="bg-surface border border-border rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
          <h3 className="text-2xl font-bold mb-4 tracking-tight">Auto-Generated Quizzes</h3>
        ...
        <div className="bg-surface border border-border rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
          <h3 className="text-2xl font-bold mb-4 tracking-tight">Learning Analytics</h3>
