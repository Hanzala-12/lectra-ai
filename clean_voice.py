...
Examples:
  ...
  python clean_voice.py file1.mp3 file2.wav file3.mp4
    ...
    parser.add_argument(
        "--recursive", action="store_true", help="Search recursively in batch mode"
    )

    # Transcript options
    parser.add_argument(
        "-t", "--transcript", action="store_true", help="Generate transcript"
    )
    ...
    parser.add_argument(
        "--no-video", action="store_true", help="Don't merge audio back to video"
    )
